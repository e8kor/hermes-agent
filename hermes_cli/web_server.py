...
def _profile_to_dict(info) -> Dict[str, Any]:
    return {
        ...
        "tags": list(_profile_attr(info, "tags", None) or []),
...
def _fallback_profile_dicts(profiles_mod) -> List[Dict[str, Any]]:
    ...
    if default_home.is_dir():
        ...
        profiles.append({
            ...
            "tags": _safe(lambda: profiles_mod.read_profile_meta(default_home).get("tags", []), []),
    ...
    if profiles_root.is_dir():
        ...
        for entry in entries:
            ...
            profiles.append({
                ...
                "tags": _safe(lambda entry=entry_path: profiles_mod.read_profile_meta(entry).get("tags", []), []),
                "distribution_name": None,
                "distribution_version": None,
                "distribution_source": None,
                "has_alias": False,
